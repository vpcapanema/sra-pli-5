...
export { C as CellMargins, a as ConditionalFormatStyle, E as EmphasisMark, F as FloatingTableProperties, L as LineSpacingRule, b as ParagraphAlignment, P as ParagraphFormatting, c as TabLeader, d as TabStop, e as TabStopAlignment, f as TableBorders, g as TableCellFormatting, h as TableFormatting, i as TableLook, j as TableMeasurement, k as TableRowFormatting, l as TableWidthType, m as TextEffect, T as TextFormatting, U as UnderlineStyle } from '../formatting-D9I-lFS4.mjs';
import { N as NumberingDefinitions } from '../lists-JDB80qyP.mjs';
export { A as AbstractNumbering, a as LevelSuffix, L as ListLevel, b as ListRendering, c as NumberFormat, d as NumberingInstance } from '../lists-JDB80qyP.mjs';
import { DocumentBody, Footnote, Endnote, HeaderFooter } from './content.mjs';
export { BlockContent, BlockSdt, BookmarkEnd, BookmarkStart, BreakContent, Column, Comment, CommentRangeEnd, CommentRangeStart, ComplexField, Deletion, DrawingContent, EndnotePosition, EndnoteProperties, Field, FieldCharContent, FieldType, FooterReference, FootnotePosition, FootnoteProperties, HeaderFooterType, HeaderReference, Hyperlink, Image, ImageCrop, ImagePadding, ImagePosition, ImageSize, ImageTransform, ImageWrap, InlineSdt, Insertion, InstrTextContent, LineNumberRestart, MathEquation, MoveFrom, MoveFromRangeEnd, MoveFromRangeStart, MoveTo, MoveToRangeEnd, MoveToRangeStart, NoBreakHyphenContent, NoteNumberRestart, NoteReferenceContent, PageOrientation, Paragraph, ParagraphContent, ParagraphPropertyChange, PropertyChangeInfo, Run, RunContent, RunPropertyChange, SdtProperties, SdtType, Section, SectionProperties, SectionStart, Shape, ShapeContent, ShapeFill, ShapeOutline, ShapeTextBody, ShapeType, SimpleField, SoftHyphenContent, SymbolContent, TabContent, Table, TableCell, TableCellPropertyChange, TablePropertyChange, TableRow, TableRowPropertyChange, TableStructuralChangeInfo, TextBox, TextContent, TrackedChangeInfo, TrackedRunChange, VerticalAlign } from './content.mjs';
import { a as StyleDefinitions, T as Theme, F as FontTable, b as RelationshipMap, M as MediaFile } from '../styles-BBoqh07F.mjs';
export { D as DocDefaults, c as FontInfo, R as Relationship, d as RelationshipType, S as Style, e as StyleType, f as ThemeColorScheme, g as ThemeFont, h as ThemeFontScheme } from '../styles-BBoqh07F.mjs';
...
export { type Document, DocumentBody, type DocxPackage, Endnote, FontTable, Footnote, HeaderFooter, MediaFile, NumberingDefinitions, RelationshipMap, StyleDefinitions, Theme };
