...
export { s as serializeDocumentBody, a as serializeDocx, b as serializeSectionProperties } from './documentSerializer-C1ueey5d.mjs';
...
export { C as CreateEmptyDocumentOptions, P as ProcessTemplateOptions, a as ProcessTemplateResult, z as ThemeMatrixCell, b as blendColors, c as colorsEqual, d as createDocumentWithText, e as createEmptyDocument, f as createRgbColor, h as createThemeColor, i as darkenColor, A as ensureHexPrefix, B as generateThemeTintShadeMatrix, j as getContrastingColor, l as getTemplateTags, D as getThemeTintShadeHex, m as isBlack, n as isWhite, o as lightenColor, p as parseColorString, r as processTemplate, t as processTemplateAsBlob, u as processTemplateDetailed, v as resolveColor, w as resolveHighlightColor, E as resolveHighlightToCss, x as resolveShadingColor, y as validateTemplate } from './colorResolver-C3q7MLLD.mjs';
export { A as AgentContextOptions, D as DocumentAgent, E as ExtendedSelectionContext, e as SelectionContextOptions, f as buildExtendedSelectionContext, g as buildSelectionContext, k as executeCommand, l as executeCommands, m as getAgentContext, n as getDocumentSummary } from './selectionContext-Xq3AY7pn.mjs';
...
export { b as CorePlugin, M as McpSession, f as McpToolDefinition, g as McpToolHandler, h as McpToolResult } from './types-dYdjUZMo.mjs';
export { P as PluginRegistry, p as pluginRegistry, r as registerPlugins } from './registry-Cpyybgij.mjs';
...
import { Run } from './types/content.mjs';
export { BlockContent, BookmarkEnd, BookmarkStart, Comment, CommentRangeEnd, CommentRangeStart, Deletion, DocumentBody, Endnote, Field, FooterReference, Footnote, HeaderFooter, HeaderReference, Hyperlink, Image, Insertion, MoveFrom, MoveTo, Paragraph, ParagraphContent, RunContent, SectionProperties, Shape, Table, TableCell, TableRow, TextBox, TextContent, TrackedChangeInfo, TrackedRunChange } from './types/content.mjs';
import { EditorView } from 'prosemirror-view';
export { FlowBlock, FootnoteContent, Layout, Measure, Page } from './layout-engine/types.mjs';
export { P as ParagraphFormatting, T as TextFormatting } from './formatting-D9I-lFS4.mjs';
export { C as ConvertFootnoteOptions, a as ConvertHeaderFooterOptions, F as FOOTNOTE_SEPARATOR_HEIGHT, H as HeaderFooterMetrics, M as MAX_FOOTNOTE_LAYOUT_PASSES, b as MeasureBlocksFn, S as StabilizeFootnoteLayoutArgs, c as StabilizeFootnoteLayoutResult, d as buildFootnoteContentMap, e as buildFootnoteRenderItems, f as calculateFootnoteReservedHeights, g as collectFootnoteRefs, h as convertHeaderFooterToContent, i as footnoteReservedHeightsEqual, m as mapFootnotesToPages, s as stabilizeFootnoteLayout } from './headerFooterLayout-DkclHZ0Z.mjs';
export { L as ListLevel, N as NumberingDefinitions } from './lists-JDB80qyP.mjs';
export { R as Relationship, S as Style, a as StyleDefinitions, T as Theme, f as ThemeColorScheme, g as ThemeFont, h as ThemeFontScheme } from './styles-BBoqh07F.mjs';
