...
import { Image, Endnote, Footnote, EndnoteProperties, FootnoteProperties, Run, FieldType, Field, SimpleField, Hyperlink, Shape, Table, TableCell, Paragraph, TextBox, ImageSize, ImagePosition, ImageWrap, BlockContent, Comment } from '../types/content.js';
import { b as RelationshipMap, M as MediaFile, S as Style, T as Theme } from '../styles-jqO45PSq.js';
import { Element } from 'xml-js';
import { N as NumberingDefinitions, L as ListLevel, A as AbstractNumbering, d as NumberingInstance, c as NumberFormat } from '../lists-CdiIk_c1.js';
import { e as TabStopAlignment, c as TabLeader, d as TabStop, C as CellMargins, F as FloatingTableProperties, f as TableBorders, i as TableLook, j as TableMeasurement, h as TableFormatting } from '../formatting-BwpZWdGi.js';
